...
export default {
  ...
  setup() {
    ...
    const register = async () => {
      try {
        ...
        await setDoc(doc(db, 'authUsers', user.uid), {
          ...
          isVerified: false, // Track whether email is verified
    ...
    return { firstName, lastName, username, email, password, confirmPassword, register, message, error, showPopup, displayPopup };
  },
};
</script>
