    ...
    <div class="login-box">
      <div class="logo-header">
        ...
        <div class="logo-center">
          <img src="/src/images/mejico-MDSpa-logo-transparent2.png" 
               alt="Mejico Medical MD Spa Clinic" class="logo-image" />
        </div>
      </div>
        ...
        <form @submit.prevent="handleLogin" class="login-form">
          <div class="form-group">
            ...
            <div class="input-wrapper">
              <span class="input-icon"><Mail class="icon" /></span>
              <input 
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              <span class="input-icon"><Lock class="icon" /></span>
              <input 
...
export default {
  setup() {
    ...
    const displayPopup = (msg, error = false) => {
    ...
    const handleResetPassword = async () => {
      try {
        ...
        displayPopup('Failed to send password reset email.', true);
      }
    };
