...
const routes = [
  ...
  { 
    ...
    submenu: [
      ...
      { path: '/admin/stock-forecasting', name: 'Stock Forecasting' },
    ]
  },
  // { 
  //   name: 'Reports',
  //   submenu: [
  //     { path: '/admin/financial-reports', name: 'Financial Reports' },
  //     { path: '/admin/performance-metrics', name: 'Performance Metrics' },
  //     { path: '/admin/client-analytics', name: 'Client Analytics' },
  //   ]
  // },
  // { 
  //   name: 'Settings',
